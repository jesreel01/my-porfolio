        ...
        <section className="mt-2 sm:mt-6 mb-12 flex flex-col items-center gap-x-14 xl:flex-row">
          <div >
            ...
            <h2 className="text-xl font-normal">
              ...
              NestJs, and AWS, and many more. I enjoy working on projects that
          ...
          <div className="flex items-center justify-center w-full sm:mt-5">
            <div className="grid grid-rows-3 gap-6 py-12 w-full max-w-96 text-center sm-12 sm:gap-8">
              <a
                target="_blank"
                // href=""
                className="rounded-md border-2 border-black p-3 shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] transition-all hover:translate-x-[3px] hover:translate-y-[3px] hover:shadow-none"
              >
                Projects
              </a>
              <a
